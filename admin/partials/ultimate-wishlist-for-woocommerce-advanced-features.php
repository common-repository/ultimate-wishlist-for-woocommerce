 ...
 *
 * This file is used to markup the html field for advanced features tab.
 *
...
apply_filters( 'uwfw_advanced_features_array', array() );
?>
<!--  template file for admin settings. -->
<form action="" method="POST" class="mwb-uwfw-gen-section-form">
	<div class="uwfw-secion-wrap uwfw_pro_feature">
		<?php
